...
namespace LAN.Core.Eventing.SignalR
{
	...
	public class SignalREventHub : Hub
	{
		...
		public override Task OnConnected()
		{
			...
			try
			{
				var groupsToJoin = this._groupRegistrar.GetGroupsForUser(username, this.Context.QueryString.ToDictionary(x => x.Key, x => x.Value));
		...
		public override Task OnDisconnected(bool stopCalled)
		{
			...
			try
			{
				var groupsToLeave = this._groupRegistrar.GetGroupsForUser(username, this.Context.QueryString.ToDictionary(x => x.Key, x => x.Value));
